...
const std::string TOPIC_PERCEPTION_TRAFFICLIGHT =
    "msg_perception_trafficlights";
...
const std::string TOPIC_PLAN_LOCALROUTE = "msg_plan_local";
...
std::string TOPIC_CONTROL_LAMP;

XmlRpc::XmlRpcValue params;
// extern int params;

}  // namespace UsrLib
// XmlRpc::XmlRpcValue* pp = &UsrLib::params456;
#endif  //_USRTOPIC_H